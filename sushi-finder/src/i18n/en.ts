...
export const en = {
  ...
  footer: {
    blurb:
      'Sushi Finder is a public sushi catalog. Sign in to keep a list of places you want to try. Data lives in Cloudflare D1 for this deployment.',
    builtWith: 'RedAnvil',
  ...
  about: {
    ...
    publicTitle: 'Public catalog, optional account',
    publicBody:
      'List, detail, search, and the assistant work without signing in. Create an account to save sushi places and mark the ones you have visited. Treat anything you type into title or description as published. Theme preference is stored only in localStorage under the key theme.'
  },
  contact: {
    title: 'Contact',
    body: 'Send a message about this catalog. For product issues you can also open an issue on the project repository associated with this Cloudflare Pages site.',
  ...
  auth: {
    ...
    forgotLead: 'Enter your email. If an account exists for it, we will send a reset link.',
    ...
    confirmExpired: 'This confirmation link is invalid or has expired. Request a new one from your account.',
    ...
    signInLead: 'Sign in to keep a list of sushi places and mark the ones you have been to.',
    signUpLead: 'Create an account to save sushi places. Passwords must be at least 12 characters.'
  },
  account: {
    title: 'Your account',
    ...
    savedTitle: 'Saved sushi places',
    savedEmpty: 'You have not saved any sushi places yet.',
    savedEmptyHint: 'Open the catalog and save a place to keep it here.',
    beenThere: 'Been there',
    notBeenThere: 'Not been yet',
    beenThereLabel: 'Been there',
    openPlace: 'Open listing',
    loading: 'Loading your account…',
    save: 'Save',
    unsave: 'Saved',
    saveAria: 'Save {title} to your list',
    unsaveAria: 'Remove {title} from your list',
    signInToSave: 'Sign in to save',
    signInToSaveAria: 'Sign in to save {title}',
    error: 'Could not update your saved places.',
    retry: 'Retry',
