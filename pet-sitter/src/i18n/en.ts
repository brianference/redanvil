...
export const en = {
  ...
  home: {
    ...
    searchPlaceholder: 'Leslieville, Annex…',
    searchSubmit: 'Search',
    searchGo: 'Go',
  ...
  views: {
    ...
    checkOut: 'Check-out',
    whereLabel: 'Where',
    petFilters: 'Pet type filters',
    allPets: 'All pets',
    dogs: 'Dogs',
    cats: 'Cats',
    smallMammals: 'Small mammals',
    photosHeroTitle: 'Trusted sitters near your pet',
    photosHeroLead:
      'Browse neighbourhood hosts with real reviews, clear rates, and open dates.',
    mapAria: 'Map of local sitters',
    mapResults: 'Sitter results',
    mapSub: 'Toronto · avatar pins · sorted by distance',
    mapSearchPlaceholder: 'Neighbourhood or name',
    stayDates: 'Stay dates',
    chipAugRange: 'Aug 12–16',
    chipWeekend: 'This weekend',
    flexibleDates: 'Flexible',
    calendarAria: 'Availability calendar',
    datesTitle: 'When do you need care?',
    datesLead: 'Pick dates first — only sitters free for your stay appear below.',
    timelineHint: 'Bars show open nights this month',
    findSitters: 'Find',
  ...
  auth: {
    ...
    forgotLead:
      'Enter your email. If an account exists for it, we will send a reset link. The confirmation is the same either way.',
    ...
    signInLead:
      'Sign in to shortlist sitters you are considering and set whether you are an owner or a sitter.',
    signUpLead:
      'Create an account to shortlist sitters. Passwords must be at least 12 characters.'
  },
  account: {
    title: 'Your account',
    ...
    displayNameHint: 'Shown on your account. Sitters and owners both need a name.',
    displayNameRequired: 'Enter a display name.',
    roleLabel: 'I am a',
    roleOwner: 'Pet owner',
    roleSitter: 'Sitter',
    roleRequired: 'Pick owner or sitter.',
    saveProfile: 'Save profile',
    savingProfile: 'Saving…',
    profileSaved: 'Profile saved.',
    shortlistTitle: 'Your shortlist',
    shortlistEmpty: 'You have not shortlisted any sitters yet.',
    shortlistEmptyHint: 'Open the catalog and add a sitter you are considering.',
    shortlistOwnerHint: 'Shortlists are for owners comparing sitters.',
    openSitter: 'Open profile',
    loading: 'Loading your account…',
    add: 'Shortlist',
    remove: 'On shortlist',
    addAria: 'Add {name} to your shortlist',
    removeAria: 'Remove {name} from your shortlist',
    signInToAdd: 'Sign in to shortlist',
    signInToAddAria: 'Sign in to shortlist {name}',
    error: 'Could not update your shortlist.',
    retry: 'Retry',
    catalogLink: 'Browse sitters'
  },
  contact: {
    fieldName: 'Name',
