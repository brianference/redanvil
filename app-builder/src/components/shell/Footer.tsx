/**
 * Thin wrapper: supplies app-builder product links and copy to the shared Footer.
 */
import { Footer as SharedFooter, type FooterTokens } from '../../../../design-system/Footer';
import { en } from '../../i18n/en';
import { theme } from '../../theme';
import { DASHBOARD_URL, FOOTER_LOGO_HEIGHT, GITHUB_URL } from './constants';
...
export function Footer(): JSX.Element {
  ...
  return (
    <SharedFooter
      ...
      copyright={en.app.footerCopyright(new Date().getFullYear())}
      quality={en.app.footerQuality}
      safeAreaBottom
    />
  );
}
