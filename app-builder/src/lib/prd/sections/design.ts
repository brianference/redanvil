...
export function buildDesignDirection(seed: string): string {
  ...
  return [
    ...
    '',
    '- [ ] Find **three** real references for this archetype and direction (Mobbin, Godly,',
    '      Land-book, Dribbble, or a product you already admire). Note what each does with the',
    '      primary surface. Do not copy a layout wholesale — take one idea from each.',
    '- [ ] Build the token set for the visual direction FIRST, then the shell, then screens.',
