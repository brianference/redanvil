...
export const EXAMPLES: readonly Example[] = [
  {
    slug: 'sushi-finder',
    name: 'Sushi Finder',
    kicker: 'Worldwide · live Google Places',
    tagline:
      'Find sushi anywhere -- browse by photos, by a map of nearby places, or by list, with live results from Google Places for any city or zip.',
    categories: ['Marketplaces', 'All'],
    stats: ['3 views', '6 seeded rows', 'live Places search', '38 tests'],
    prompt:
      'A worldwide sushi finder: discover sushi restaurants near you or in any city, see omakase vs conveyor vs counter style, price band, whether they take walk-ins, and real reviews. Browse by photos, by map, or by when a seating is available.',
    answers: [
      {
        label: 'Built from',
        value: 'PRD generated by driving this builder’s own wizard (50,456 chars)'
      },
      { label: 'Live auth model', value: 'No sign-in; catalog and Places search are public GETs' },
      { label: 'Live data (2026-08-10)', value: 'D1 catalog of 6 curated places, plus Google Places for any query' }
    ],
    logo: '/examples/sushi-finder/logo.webp',
    screens: [
      {
        src: '/examples/sushi-finder/home-375-light.webp',
        caption: 'Editorial hero over a photo grid',
        alt: 'Sushi Finder on a phone in light theme: a featured restaurant with its story above a grid of photo cards',
        width: 375,
        height: 812
      },
      {
        src: '/examples/sushi-finder/home-375-dark.webp',
        caption: 'Indigo Mon Crest in dark',
        alt: 'Sushi Finder on a phone in dark theme showing the indigo palette',
        width: 375,
        height: 812
      },
      {
        src: '/examples/sushi-finder/home-1280-light.webp',
        caption: 'Desktop browse',
        alt: 'Sushi Finder on a desktop browser in light theme',
        width: 1280,
        height: 900
      },
      {
        src: '/examples/sushi-finder/home-1280-dark.webp',
        caption: 'Desktop, dark',
        alt: 'Sushi Finder on a desktop browser in dark theme',
        width: 1280,
        height: 900
      }
    ],
    liveUrl: 'https://sushi-finder.pages.dev',
    gate:
      'Gate 0/100 at 70/81 rules measured 2026-08-10, with 17 rules waived and recorded in .redanvil/known-issues.json. This is NOT a passing gate: the score is published as measured rather than as hoped. Test lanes are green -- vitest, 27 acceptance against the deployed build, and 11 pytest live-API invariants.',
    features: [
      {
        area: 'Discovery',
        items: [
          'Three views over one dataset: Photos, Map and List, switched from the header and carried in the URL',
          'Search any city or US zip; results below the six curated rows come live from Google Places',
          'Map plots every result by real latitude and longitude, framed to the results'
        ]
      },
      {
        area: 'Each place',
        items: [
          'Style, price band and city on every card',
          'Google rating where the provider reports one',
          'Detail page per restaurant'
        ]
      },
      {
        area: 'Shell',
        items: [
          'Light and dark, following a stored choice and defaulting to light on arrival',
          'Assistant answers questions grounded in the catalog',
  ...
  },
  {
    ...
    kicker: 'Toronto · three views',
    tagline:
      'Find a neighbourhood pet sitter -- browse faces and rates, see who is nearby on a map, or pick the dates you need covered.',
    categories: ['Marketplaces', 'All'],
    stats: ['3 views', '8 sitters', '23 tests', 'axe clean'],
    prompt:
      'A pet sitter finder: browse local sitters by neighbourhood, pet type, nightly rate and verified reviews, with search that narrows the catalog.',
    answers: [
      { label: 'Live auth model', value: 'No sign-in required to browse; sitter list is a public GET' },
      { label: 'Live data (2026-08-10)', value: 'D1 via /api/sitters: 8 sitters with real neighbourhoods, rates and review counts' },
      { label: 'Imagery', value: 'Sitter portraits generated with image_gen; provenance recorded in SOURCES.md' }
    ],
    logo: '/examples/pet-sitter/logo.webp',
    screens: [
      {
        src: '/examples/pet-sitter/home-375-light.webp',
        caption: 'Browse sitters by photo',
        alt: 'Pet Sitter Finder on a phone in light theme showing sitter cards with photos, rates and availability',
        width: 375,
        height: 812
      },
      {
        src: '/examples/pet-sitter/home-375-dark.webp',
        caption: 'Dark theme',
        alt: 'Pet Sitter Finder on a phone in dark theme',
        width: 375,
        height: 812
      },
      {
        src: '/examples/pet-sitter/home-1280-light.webp',
        caption: 'Desktop browse',
        alt: 'Pet Sitter Finder on a desktop browser in light theme',
        width: 1280,
        height: 900
      },
      {
        src: '/examples/pet-sitter/home-1280-dark.webp',
        caption: 'Desktop, dark',
        alt: 'Pet Sitter Finder on a desktop browser in dark theme',
        width: 1280,
        height: 900
      }
    ],
    liveUrl: 'https://pet-sitter-vz1.pages.dev',
    gate:
      'Gate 0/100 at 87/87 rules on the last recorded run. The score predates a theme revert on 2026-08-10 and is stale, so it is shown as measured rather than re-asserted. Verified live: axe-core reports zero colour-contrast violations in both themes and the deployed build serves the built asset hash.',
    features: [
      {
        area: 'Discovery',
        items: [
          'Three views over one dataset: Photos, Map and Dates, carried in the URL',
          'Search narrows the sitter list server-side',
          'Map places each sitter as an avatar pin with a bottom sheet of results'
        ]
      },
      {
        area: 'Each sitter',
        items: [
          'Pet-type pills, nightly rate and availability dates',
          'Rating with review count where a review row exists, and "Verified" where none does',
          'Detail page per sitter'
        ]
      },
      {
        area: 'Shell',
        items: [
          'Light and dark with a visible toggle that persists',
          'Assistant grounded in the sitter database',
          'About, Contact, Terms and Privacy'
        ]
      }
    ],
