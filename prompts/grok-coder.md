...
- `DONE-CHECKLIST.md` ships in the working directory. It is the definition of done, and the gate evaluates every row. Read it before you start. Do not report an item finished without the evidence artifact that row names — a plan, a prompt, or your own summary is never evidence.
