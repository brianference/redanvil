...
- proc-design-options (blocker, det): `design-refs/design-options/` contains at least three option artifacts (HTML or image) and a `DECISION.md` that names which was chosen, why, and how the three differ structurally. Unwritten markers (TBD, Fill this in, TODO) fail. §7.3a called the three-option step not optional; it was never measured.
